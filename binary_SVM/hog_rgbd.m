...
save( sprintf('%s%d', 'classifiers/hog_rgbd_', percent), 'classifier' );

fileID = fopen( sprintf('%s%d', 'results/hog_rgbd_res_', percent), 'wt+' );
...
%% hog with SVM RGBD
%% it seems hog RGBD without surfnorm works better
